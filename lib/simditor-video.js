(function() {
  ...
  (function(factory) {
    if (typeof exports === 'object') {
      ...
      // like Node.
     module.exports = factory(require("jquery"),require("simditor"), window.video);
    }
    else if ((typeof define === 'function') && define.amd) {
      return define(['jquery', 'simditor', 'video'], factory);
    } else {
      return factory(jQuery, window.Simditor, window.video);
    }
